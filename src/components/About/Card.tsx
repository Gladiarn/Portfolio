...
export default function Card({ card, activeCard, index }: { card: cardInfosTypes , activeCard: number, index:number }) {
  return (
    <div
      ...
      } xl:flex xl:flex-col xl:opacity-100 xl:pointer-events-auto xl:Scale-100 transition-all duration-300 ease-in-out text-center items-center gap-3 max-w-[350px] absolute xl:static bg-card/10 backdrop-blur-sm px-3 py-3 rounded-md border border-accent `}
    >
      <div
