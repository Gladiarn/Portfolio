  ...
  const cardsInfo: cardInfosTypes[] = [
    {
      ...
      icon: (
        <Rabbit className="h-[32px] w-[32px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-foregroundWithAccent" />
      ),
    },
    {
      ...
      icon: (
        <HeartHandshake className="h-[32px] w-[32px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-foregroundWithAccent" />
      ),
    },
    {
      ...
      icon: (
        <Puzzle className="h-[32px] w-[32px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-foregroundWithAccent" />
      ),
    },
    {
      ...
      icon: (
        <BrainCog className="h-[32px] w-[32px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-foregroundWithAccent" />
      ),
    },
  ];
