  ...
  return (
    <div className="w-full h-auto py-3 px-4 md:px-[50px] xl:px-[200px] flex items-center text-foreground justify-between">
      <div className="flex gap-3 items-center">
        ...
        <button className="border border-foreground text-foregorund relative flex justify-center h-[34px] w-[40px] rounded-md font-bold text-[14px] sm:hover:w-[120px] overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.76,0,0.24,1)] group hover:border-accent">
